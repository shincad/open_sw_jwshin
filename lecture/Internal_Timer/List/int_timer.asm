...
; 0000 0021     TCNT1 = 49911;
	LDI  R30,LOW(49911)
	LDI  R31,HIGH(49911)
	OUT  0x2C+1,R31
	OUT  0x2C,R30
; 0000 0022     if(PORTC == 0xff) PORTC = 0x00;
	IN   R30,0x15
	CPI  R30,LOW(0xFF)
	BRNE _0x3
	LDI  R30,LOW(0)
	RJMP _0xA
; 0000 0023     else if (PORTC == 0x00) PORTC = 0xff;
_0x3:
	IN   R30,0x15
	CPI  R30,0
	BRNE _0x5
...
; 0000 006B // Timer Period: 4.1943 s
...
; 0000 0071 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<COM1C1) | (0<<COM1C0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
...
; 0000 007A OCR1BL=0x00;
	OUT  0x28,R30
; 0000 007B OCR1CH=0x00;
	STS  121,R30
; 0000 007C OCR1CL=0x00;
	STS  120,R30
; 0000 007D 
...
; 0000 0085 OCR2=0x00;
	OUT  0x23,R30
; 0000 0086 
; 0000 0087 // Timer/Counter 3 initialization
; 0000 0088 // Clock source: System Clock
; 0000 0089 // Clock value: Timer3 Stopped
; 0000 008A // Mode: Normal top=0xFFFF
; 0000 008B // OC3A output: Disconnected
; 0000 008C // OC3B output: Disconnected
; 0000 008D // OC3C output: Disconnected
; 0000 008E // Noise Canceler: Off
; 0000 008F // Input Capture on Falling Edge
; 0000 0090 // Timer3 Overflow Interrupt: Off
...
; 0000 0095 TCCR3A=(0<<COM3A1) | (0<<COM3A0) | (0<<COM3B1) | (0<<COM3B0) | (0<<COM3C1) | (0<<COM3C0) | (0<<WGM31) | (0<<WGM30);
	STS  139,R30
; 0000 0096 TCCR3B=(0<<ICNC3) | (0<<ICES3) | (0<<WGM33) | (0<<WGM32) | (0<<CS32) | (0<<CS31) | (0<<CS30);
	STS  138,R30
; 0000 0097 TCNT3H=0x00;
	STS  137,R30
; 0000 0098 TCNT3L=0x00;
	STS  136,R30
; 0000 0099 ICR3H=0x00;
	STS  129,R30
; 0000 009A ICR3L=0x00;
	STS  128,R30
; 0000 009B OCR3AH=0x00;
	STS  135,R30
; 0000 009C OCR3AL=0x00;
	STS  134,R30
; 0000 009D OCR3BH=0x00;
	STS  133,R30
; 0000 009E OCR3BL=0x00;
	STS  132,R30
; 0000 009F OCR3CH=0x00;
	STS  131,R30
; 0000 00A0 OCR3CL=0x00;
	STS  130,R30
; 0000 00A1 
; 0000 00A2 // Timer(s)/Counter(s) Interrupt(s) initialization
; 0000 00A3 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (1<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(4)
	OUT  0x37,R30
; 0000 00A4 
