...
_getch:
; .FSTART _getch
; 0000 0029     while(!(UCSR0A & 0x80));
_0x6:
	SBIS 0xB,7
	RJMP _0x6
; 0000 002A     return UDR0;
	IN   R30,0xC
	RET
; 0000 002B }
; .FEND
...
; 0000 0032       char data = 0;
; 0000 0033       UCSR0A = 0x00;
;	data -> R17
	LDI  R17,0
	RCALL SUBOPT_0x0
; 0000 0034       UCSR0B = 0x18;
; 0000 0035       UCSR0C = 0x06;
; 0000 0036       UBRR0H = 0x00;
; 0000 0037       UBRR0L = 0x67;
; 0000 0038 
; 0000 0039 
...
; 0000 005D PORTF=(0<<PORTF7) | (0<<PORTF6) | (0<<PORTF5) | (0<<PORTF4) | (0<<PORTF3) | (0<<PORTF2) | (0<<PORTF1) | (0<<PORTF0);
	STS  98,R30
; 0000 005E 
...
; 0000 00AF TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x37,R30
; 0000 00B0 
; 0000 00B1 ETIMSK=(0<<TICIE3) | (0<<OCIE3A) | (0<<OCIE3B) | (0<<TOIE3) | (0<<OCIE3C) | (0<<OCIE1C);
	STS  125,R30
; 0000 00B2 
...
; 0000 00BD EICRB=(0<<ISC71) | (0<<ISC70) | (0<<ISC61) | (0<<ISC60) | (0<<ISC51) | (0<<ISC50) | (0<<ISC41) | (0<<ISC40);
	OUT  0x3A,R30
; 0000 00BE EIMSK=(0<<INT7) | (0<<INT6) | (0<<INT5) | (0<<INT4) | (0<<INT3) | (0<<INT2) | (0<<INT1) | (0<<INT0);
	OUT  0x39,R30
; 0000 00BF 
; 0000 00C0 // USART0 initialization
; 0000 00C1 // Communication Parameters: 8 Data, 1 Stop, No Parity
; 0000 00C2 // USART0 Receiver: On
; 0000 00C3 // USART0 Transmitter: On
; 0000 00C4 // USART0 Mode: Asynchronous
; 0000 00C5 // USART0 Baud Rate: 9600
; 0000 00C6 UCSR0A=(0<<RXC0) | (0<<TXC0) | (0<<UDRE0) | (0<<FE0) | (0<<DOR0) | (0<<UPE0) | (0<<U2X0) | (0<<MPCM0);
	RCALL SUBOPT_0x0
; 0000 00C7 UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (1<<RXEN0) | (1<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
; 0000 00C8 UCSR0C=(0<<UMSEL0) | (0<<UPM01) | (0<<UPM00) | (0<<USBS0) | (1<<UCSZ01) | (1<<UCSZ00) | (0<<UCPOL0);
...
_0x9:
; 0000 00E5       {
; 0000 00E6       // Place your code here
; 0000 00E7         data = getch();
	RCALL _getch
	MOV  R17,R30
; 0000 00E8 
; 0000 00E9         putch(data);
	MOV  R26,R17
	RCALL _putch
; 0000 00EA 
; 0000 00EB 
