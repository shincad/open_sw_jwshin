...
void cnttest1()
{   int i=0;
    atc_a_write(0x68,0x80);
    atc_b_write(0x68,0x80);
    ...
    while(1) {
        ...
        atc_a_write(0x66,0x11);								  /* IC2 */	
        atc_a_write(0x60,0xff);
       	s_printf("Counter Value3: %x \n",atc_a_rd(0x60));     /* LSB Read */

  		atc_a_write(0x66,0x91);
  		atc_a_write(0x64,0xff);
        s_printf("Counter Value3 Counter 2 Read: %x \n",atc_a_rd(0x64));     /* LSB Read */


        atc_a_write(0x76,0x17);								  /* IC1 Counter 0 */ 		
        atc_a_write(0x70,0x44);
        s_printf("Counter Value4-0: %x \n",atc_a_rd(0x70));     /* LSB Read */
        														/* IC1 Counter Value can not read... because of IC57.. */
